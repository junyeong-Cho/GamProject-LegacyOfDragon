...
void Map_setting::boss1_creating()
{
	...
	for (int x = 0; x < 10; x++) {
		for (int y = 0; y < 10; y++) {
			...
			int tile = map_setting.boss1_map[y][x];
...
void Map_setting::char_pos_boss1(Player* player)
{
	for (int x = 0; x < 10; x++) {
		for (int y = 0; y < 10; y++) {
			if (map_setting.boss1_map[y][x] == map_setting.CHARA) {
